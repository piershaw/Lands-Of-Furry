...
import com.pt.furry.BTActivity;
import com.pt.furry.iBlueTooth;
...
public class BluetoothManager implements iBlueTooth {
	...
	public BluetoothManager(Activity activity, Handler handler,Context appContext) {
		init();
	...
	public synchronized void connect(BluetoothDevice device) {
		...
		//nrw code
			TBlue	tBlue = new TBlue(device.getAddress().toUpperCase());
			MyGdxGame.setBlueTooth(tBlue);

			Log.i("furry","address"+device.getAddress());
	}
